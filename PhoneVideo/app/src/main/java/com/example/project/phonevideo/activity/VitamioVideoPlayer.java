...
import com.example.project.phonevideo.view.VitamioVideoView;
        ...
        public boolean onInfo(MediaPlayer mp, int what, int extra) {
            switch (what){
                ...
                case MediaPlayer.MEDIA_INFO_BUFFERING_END://视频卡结束了拖动卡结束了
                    Toast.makeText(VitamioVideoPlayer.this,"卡完了",Toast.LENGTH_SHORT).show();
...
//设置音量的大小
    ...
    private void setData() {
        if (mediaItems != null && mediaItems.size()>0){
            ...
            Toast.makeText(VitamioVideoPlayer.this,"大哥你没有传递数据",Toast.LENGTH_SHORT).show();
        }
        setButtonState();
    ...
    private void showSwitchDialog() {
        ...
        builder.setTitle("提示");
        builder.setMessage("当你播放视频有声音无画面请切换系统播放器");
...
//播放下一个视频
    ...
    Handler handler =   new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case SHOW_SPEED:
                    String netspeed = timeUtils.getNetSpeed(VitamioVideoPlayer.this);
                ...
                case PROGRESS:
                    //1.得到当前视频的播放进度
                    int currenPoisiton = (int) videoView.getCurrentPosition();
